          ...
          {showText && (
            <div className="slider-overlay">
              <div className="overlay-content">
                <h2 className="overlay-title">Discover Excellence</h2>
                <p className="overlay-subtitle">Professional Solutions for Your Success</p>
                <button className="overlay-button" onClick={handleLearnMore}>Learn More</button>
              </div>
            </div>
          )}
        </div>
